// ═══════════════════════════════════════════════════════════════
// 07_analyze_main.js
// Main analyze() + getActualPctRatio (R1 fix) + EVM (~lines 6710-7820)
// Lines: 6711 - 7820 (1110 lines, 53,868 bytes)
...
function analyze(baseline, progress = null, revisedBL = null) {
  ...
  const getActualPctRatio = (p) => {
    ...
    let raw;
    // v29.0.11.2 (R1 fix per ChatGPT Round 7): Each pctType branch falls back
