// ═══════════════════════════════════════════════════════════════
// 06_dcma_audit.js
// DCMA 14-point + Network DP for Critical Path (R2 fix) (~lines 6130-6710)
// Lines: 6131 - 6710 (580 lines, 27,876 bytes)
...
//
// v29.0.11.2 (R2 fix per ChatGPT Round 7): Activities may have multiple ID fields
...
function _calculateNetworkLongestPath(activities, relationships) {
  ...
  // v29.0.11.2: Multi-key alias map — activity reachable by ANY of its IDs
  const actMap = {};
